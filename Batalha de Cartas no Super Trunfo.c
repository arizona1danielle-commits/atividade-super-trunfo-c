        ...
        int main(){
            ...
            Densidade_Populaciona = Populucao/Area;
                ...
                Super_Poder = (float)Populucao + Area + PIB
                    + Numero_de_pontos_turisticos
                    + Pib_Capita
                    + (1.0f / Densidade_Populaciona);
    ...
    printf("Populacao: Carta 1 venceu (%d)\n", Populucao > Populacao2);       
    printf("Area: Carta 1 venceu (%d)\n", Area > Area2);
    printf("PIB: Carta 1 venceu (%d)\n", PIB > PIB2);
    printf("Pontos Turisticos: Carta 1 venceu (%d)\n", Numero_de_pontos_turisticos > Numero_de_pontos_turisticos2);
    printf("Densidadde Populacional: Carta 1 venceu(%d)\n", Densidade_Populaciona < Densidade_Populacional2);
